...
def arthavi_comparison_baseline() -> dict[str, Any]:
    """Static baseline for local Ollama (arthavi-address) vs cloud."""
    return {
        "provider": "arthavi",
        "model": os.getenv("OLLAMA_MODEL", "arthavi-address"),
        "cost_usd_per_request": 0.0,
        "tokens_per_request": None,
        "typical_latency_seconds": "30–90",
        "data_residency": "On-prem / local",
        "notes": "No per-token API cost; inference runs on local Ollama.",
    }
